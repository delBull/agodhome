...
import portaladex from '@/assets/images/portaladex.png';
      ...
      <div className={clsx('w-full lg:w-auto hidden md:block')}>
        <div className={clsx(styles.imageContainer)}>
          <Image
            ...
            width={600}
            height={300}
            className={clsx(styles['floating-image'], 'adex')}
          />
        </div>
      </div>
      <SectionContent>
        <div className={clsx('flex flex-col lg:flex-row lg:gap-12')}>
          <div className={clsx('flex flex-col gap-3')}>
            <SectionButton
              ...
              description={t('tabs.communityDescription')}
            />
            <SectionButton
              title={t('tabs.exchange')}
              icon={<CalendarIcon className="my-2 h-16 w-16" />}
              description={t('tabs.exchangeDescription')}
            />
            <SectionButton
              title={t('tabs.staking')}
              icon={<SparkleIcon className="my-2 h-16 w-16" />}
              description={t('tabs.stakingDescription')}
            />
            <SectionButton
              title={t('tabs.income')}
              icon={<HeartIcon className="my-2 h-16 w-16" />}
              description={t('tabs.incomeDescription')}
            />
          </div>
        </div>
      </SectionContent>
