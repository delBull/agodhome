...
export function JavaScriptIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
    <svg
...
export function HtmlIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
...
export function CssIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
...
export function TailwindIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
...
export function NpmFileIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
...
export function FileIcon(props: ComponentProps<'svg'>): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
